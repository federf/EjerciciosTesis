//gcc -o countchar count_char_ocurrences_using_pipes.c && ./countchar e longFile.txt
...
int main( int argc, char **argv )
{
    ...
    if (argc != 3){
      printf("Incorrect number of arguments. A character and a file are needed\n");
      exit( 0 );
    }
    ...
    char *string  = ReadFile(filename, filesize);
