 ...
 *		T0 se encarga de ciclar M desde cero hasta ((M/threads)-1)
 		...
 		Y asi sucesivamente.
 */
public class ejemploParaleloProfiling extends Exception {
	...
	static int rowsA = 35000;
	static int colsARowsB = 4000;
	static int colsB = 3000;
	...
	public static void main(String[] args) throws Exception{
		...
		ejemploParaleloProfiling obj = new ejemploParaleloProfiling();
