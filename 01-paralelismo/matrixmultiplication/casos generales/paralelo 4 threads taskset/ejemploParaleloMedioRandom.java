 ...
 *		T0 se encarga de ciclar M desde cero hasta ((M/threads)-1)
 		...
 		Y asi sucesivamente.
 */
public class ejemploParaleloMedioRandom extends Exception {
	...
	static int rowsA = 260;
	static int colsARowsB = 2;
	static int colsB = 93;
	...
	public static void main(String[] args) throws Exception{
		...
		ejemploParaleloMedioRandom obj = new ejemploParaleloMedioRandom();
