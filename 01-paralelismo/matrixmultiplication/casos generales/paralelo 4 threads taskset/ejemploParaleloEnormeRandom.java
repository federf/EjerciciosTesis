 ...
 *		T0 se encarga de ciclar M desde cero hasta ((M/threads)-1)
 		...
 		Y asi sucesivamente.
 */
public class ejemploParaleloEnormeRandom extends Exception {
	...
	static int rowsA = 200;
	static int colsARowsB = 400;
	static int colsB = 5112;
	...
	public static void main(String[] args) throws Exception{
		...
		ejemploParaleloEnormeRandom obj = new ejemploParaleloEnormeRandom();
