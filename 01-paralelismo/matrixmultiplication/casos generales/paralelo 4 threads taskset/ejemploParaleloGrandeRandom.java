 ...
 *		T0 se encarga de ciclar M desde cero hasta ((M/threads)-1)
 		...
 		Y asi sucesivamente.
 */
public class ejemploParaleloGrandeRandom extends Exception {
	...
	static int rowsA = 328;
	static int colsARowsB = 10;
	static int colsB = 193;
	...
	public static void main(String[] args) throws Exception{
		...
		ejemploParaleloGrandeRandom obj = new ejemploParaleloGrandeRandom();
